            ...
            <View style={styles.container}>
              ...
              <View style={styles.phoneInputWrap}>
                <TextInput
                  ...
                  multiline={true}
                  placeholder={
                    'Enter Verification Code sent to ' + route.params.number
                  }
              ...
              <TouchableOpacity style={styles.backBtWrap}>
                <Text>
                  <Image
                    style={styles.backBt}
              ...
              <TouchableOpacity
                style={[
                  globalStyles.gradBt,
                  {width: 167, height: 31, marginBottom: 10},
                ]}
                ...
                <LinearGradient
                  ...
                  style={[
                    ...
                    {height: 38, paddingTop: 0, paddingBottom: 0},
                  ]}>
              ...
              <Text style={styles.probWithVcode}>
                Problem with {'\n'} your verification code?
              </Text>

              <Text style={styles.youCanText}>
                You can use one of the sign up{'\n'}
              ...
              <TouchableOpacity
                style={[
                  globalStyles.gradBt,
                  {width: 197, height: 38, marginTop: 30},
                ]}
              ...
              <TouchableOpacity
                style={[globalStyles.gradBt, {width: 197, height: 38}]}
              ...
              <View style={styles.Iagree}>
                <Text style={styles.IagreeText}>
                  By signing in you confirm that you are 13 years of age or
